...
Renderer::Renderer (Window &parent) : OGLRenderer (parent)
{
	...
	triangle = Mesh::GenerateTriangle (0);			//we know about triangles..
	quad = Mesh::GenerateQuad (0);				//and quads...

	//We set a couple of textures, here. Only one of them is new!
	quad->SetTexture (SOIL_load_OGL_texture (TEXTUREDIR"reticle.jpg", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_MIPMAPS));
